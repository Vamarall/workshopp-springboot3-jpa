...
public class Order implements Serializable {
	...
	// Relacionamento um-para-muitos: Um pedido pode ter vários itens associados a
	// ele.
	// "mappedBy = id.order" indica que o mapeamento já foi feito dentro da entidade
	// OrderItem.
	@OneToMany(mappedBy = "id.order")
	private Set<OrderItem> items = new HashSet<>();

	// Relacionamento um-para-um: Cada pedido possui um único pagamento.
	// "mappedBy = order" significa que a chave estrangeira está na entidade
	// Payment.
	// "cascade = CascadeType.ALL" faz com que qualquer operação no pedido afete
